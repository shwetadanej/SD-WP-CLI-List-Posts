...
class Sd_Wpcli_List_Posts {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Sd_Wpcli_List_Posts_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $plugin_display_name    The string used to display this plugin name.
	 */
	...
	public function __construct() {
		if ( defined( 'SD_WPCLI_LIST_POSTS_VERSION' ) ) {
			$this->version = SD_WPCLI_LIST_POSTS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Sd_Wpcli_List_Posts_Admin( $this->get_plugin_name(), $this->get_version(), $this->get_plugin_display_name() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Sd_Wpcli_List_Posts_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Sd_Wpcli_List_Posts_Loader    Orchestrates the hooks of the plugin.
	 */
